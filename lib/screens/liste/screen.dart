...
final List<String> entries = <String>['Tout', 'Chez Vous', 'Epicerie', 'Fruits et légumes'];
    ...
    return Scaffold(
      body: ListView(
        children: <Widget>[
          ...
          PageDescription(
            description: "Retrouvez tous les ingrédients de votre Menu ci-dessous !"
          ),
          GridView.count(
            crossAxisCount: 2,
          ...
          AsterixText(
            asterix: "* Durée variable en fonction de vos habitudes de course."
          ),
          const SizedBox(height: 10),
          MainButton(buttonText: "C'est parti, on fait les courses ->", route: _ListeScreenState()),
          TextButton(
            onPressed: () {},
                    ...
                    children: [
                        ...
                        child: ListView( 
                          ...
                          children: [
                            CustomClickableTile(
                              ...
                              img: Image.asset('lib/assets/images/bread.png'),
                            ),
                            CustomClickableTile(
                              img: Image.asset('lib/assets/images/cereal.png'), 
                              clickedTitle: "Haricots achetés",
                              title: "Haricots rouges en boite"
                            ),
                            CustomClickableTile(
                              img: Image.asset('lib/assets/images/nuts.png'), 
                              title: "Quinoa",
                            ...
                            CustomClickableTile(
                              img: Image.asset('lib/assets/images/tomato.png'), 
                      ...
                      Expanded(
                        child: ListView( 
                          ...
                          children: [
                            CustomTile(
                              icon: Image.asset('lib/assets/images/avocado.png'), 
                              tileTitle: "Avocat"
                            ),
                            CustomTile(
                              icon: Image.asset('lib/assets/images/salad.png'), 
                              tileTitle: "Roquette"
                            ),
                            CustomTile(
                              icon: Image.asset('lib/assets/images/nuts.png'), 
                              tileTitle: "Gousse d'ail"
                            ),
                            CustomTile(
                              icon: Image.asset('lib/assets/images/cereal.png'), 
                              tileTitle: "Coriande"
                            ),
                            CustomTile(
                              icon: Image.asset('lib/assets/images/tomato.png'), 
                              tileTitle: "Kiwi"
                            ),
                          ],
                        ),
                      ...
                      Expanded(
                        child: ListView( 
                          ...
                          children: [
                            ...
                            CustomTile(
                              icon: Image.asset('lib/assets/images/bread.png'), 
                              tileTitle: "Farine"
                            ),
                          ],
                        ),
